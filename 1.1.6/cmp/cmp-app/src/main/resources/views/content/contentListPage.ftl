...
<@body>
    ...
    <@panelBody>
        ...
        <@table id="home" url="cmp_/queryContentList" form_id="imageQueryForm" button_id="todoQueryButton" page_size="10" load_auto="true">
            <@th checkbox="false"/>
            ...
            <@th title="<div style='width:85px'>操作</div>" render="true">
                ...
                <#--<@href name="删除" href="/cmp_/delectContent?batchNo={{row.batchNo}}"/>-->
            </@th>
        </@table>
    </@panelBody>
</@body>