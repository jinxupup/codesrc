...
<@fieldset legend="其他联系人信息:">
    <@field label="其他联系人中文姓名" point_flag="true" point="*">
        ...
        valid={"stringlength":"true","stringlength-max":"10","stringlength-message":"请正确填写其他联系人姓名"} label_only="true"/>	</@field>
    ...
    <@field label="其他联系人移动电话" point_flag="true" point="*">
        <@input name="tmAppContact[1].contactMobile" value="${(mconItemInfo2.contactMobile)!}" valid={"regexp or pattern":"^1[3456789]\\d{9}$","regexp-message":"请输入有效的手机号"} label_only="true"/>
    </@field>
    <@field label="其他联系人联系电话">
        <@input name="tmAppContact[1].contactTelephone" value="${(mconItemInfo2.contactTelephone)!}" valid={"regexp or pattern":"^((0\\d{2,3}-\\d{6,8}(-\\d{1,6})?)|(1[3456789]\\d{9}))$","regexp-message":"请输入有效的电话号码"} label_only="true"/>
    </@field>
    <@field label="联系人类型" hidden="true">
        <#if (tmAppContact.contacType)??>
