		...
		<@field label="自选卡号">
			<div style="margin-right: -5px;margin-left: -5px;">
				...
				<div class="col-ar-16" style="padding-right:0px;padding-left:0px;">
					<@input id="cardNo" name="tmAppPrimApplicantInfo.cardNo" value="${(tmAppPrimApplicantInfo.cardNo)!}" valid={"regexp or pattern":"^(\\d{9}$)","regexp-message":"请输入9位正确的自选卡号"}/>
				</div>
...
<@fieldset legend="职业资料:">
	...
	<@row>
		<@field label="公司名称" field_ar="24" label_ar="7" input_ar="29">
			<@input name="tmAppPrimApplicantInfo.corpName" value="${(tmAppPrimApplicantInfo.corpName)!}" 
				valid={"stringlength":"true","stringlength-max":"80","stringlength-message":"请正确填写公司名称"}/>
		</@field>
		<@field label="公司性质">
			<@dictSelect dicttype="EmpStructure" name="tmAppPrimApplicantInfo.empStructure" value="${(tmAppPrimApplicantInfo.empStructure)!}"/>
		</@field>
	</@row>
	<@row>
	<#--	<@field label="现单位工作起始年月">
		...
		<@field label="公司行业类别">
          	<@dictSelect dicttype="EmpType" name="tmAppPrimApplicantInfo.empType" value="${(tmAppPrimApplicantInfo.empType)!}" />
        </@field>	
		<@field label="现单位工作年限">
	...
	<@row>
		...
		<@field label="公司所在区/县">
			<@selectLink  options=dict_("tableMap","com.jjb.acl.infrastructure.TmAclDict",'{"type":"ZONE","value2":"'+(ar_("blank",(tmAppPrimApplicantInfo.empCity)!,"九江市"))+'"}',"codeName","codeName")
	...
	<@row>
		<@field label="公司地址">
			<@input name="empAdd"  name="tmAppPrimApplicantInfo.empAdd" value="${(tmAppPrimApplicantInfo.empAdd)!}" />
		</@field>
		<@field label="公司邮编">
			<@input name="tmAppPrimApplicantInfo.empPostcode" value="${(tmAppPrimApplicantInfo.empPostcode)!}" valid={"regexp or pattern":"^(\\d{6}$)","regexp-message":"请输入有效的邮编"}/>
		</@field>
		<@field label="公司电话">
			<@input name="tmAppPrimApplicantInfo.empPhone" value="${(tmAppPrimApplicantInfo.empPhone)!}" valid={"regexp or pattern":"${(appPhone)!}","regexp-message":"请输入有效的电话号码"}/>
		</@field>
	</@row>
	<@row>	             
		<@field label="是否行内员工">
...
<@fieldset legend="直系亲属联系人信息:">
	<@row>
		<@field label="联系人姓名">
			<@input name="tmAppContact[0].contactName" value="${(tmAppContact1.contactName)!}"
				valid={"stringlength":"true","stringlength-max":"10","stringlength-message":"请正确填写直系亲属联系人姓名"}/>
		</@field>
...
<@fieldset legend="自动还款授权及消费方式:">
	<@row>
	    ...
	    <@field label="约定还款账户类型">
			<@dictSelect id="ddBankAcctNoType" dicttype="DdBankAcctNoType" name="tmAppPrimCardInfo.ddBankAcctNoType" value="${(tmAppPrimCardInfo.ddBankAcctNoType)!'Y'}" nullable="false"/>
		</@field>
	</@row>
	<@row>
    	<@field label="约定还款开户行号" point_flag="${(otherInfoMap['ddBankBranch'])!}" point="*">
			<@dictSelect id="ddBankBranch" dicttype="DdBankBranch" change="ddBankBranchChange" name="tmAppPrimCardInfo.ddBankBranch" value="${(tmAppPrimCardInfo.ddBankBranch)!}" nullable="false"/>
		</@field>
		<@field label="约定还款银行名称" point_flag="${(otherInfoMap['ddBankName'])!}" point="*">
			<@input id="ddBankName"  name="tmAppPrimCardInfo.ddBankName" value="${(tmAppPrimCardInfo.ddBankName)!}"/>
		</@field>
