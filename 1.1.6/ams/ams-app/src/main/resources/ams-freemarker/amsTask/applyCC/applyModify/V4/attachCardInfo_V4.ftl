				...
				<@field label="自选卡号">
					<div style="margin-right: -5px;margin-left: -5px;">
						...
						<div class="col-ar-14" style="padding-right:0px;padding-left:0px;">
							<@input id="cardNo" readonly="true" name="tmAppAttachApplierInfo.cardNo" value="${(tmAppAttachApplierInfo.cardNo)!}" valid={"regexp or pattern":"${(selectCardNoRegexp)!}","regexp-message":"请输入正确的自选卡号"}/>
						</div>
