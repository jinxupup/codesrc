...
public class AmsErrorMsgUtil {
	...
	public static final String[] BlPersonal = new String[]{"blacklistSrc","idType","idNo","name","cellphone","homePhone","homeAdd",
			"corpName","empPhone","empAdd","validDate","actType","riskLevel","reason","memo"};//黑名单信息
