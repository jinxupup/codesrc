package com.jjb.cas.batch.s0010;
...
public class P0010Test {/*
	...
	*//**
	 ...
	 *//*
	@Resource
	private YakFileResourceMock<FileHeader, ApplyResponseItem> resS000010Response;
	...
	*//**
	...
	public void setUp() throws Exception {
		...
		//创建文件
		resS000010Response.prepare(new FileHeader(), items);
	}
	...
	*//**
	...
	public void testCase1() throws Exception {
		...
		JobExecution e = jobLauncherTestUtils.launchStep("s0010-applyresponse");
