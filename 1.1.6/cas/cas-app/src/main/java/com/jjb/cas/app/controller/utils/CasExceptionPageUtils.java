...
@Service
public class CasExceptionPageUtils extends BaseController{
	
	private final static Logger logger = LoggerFactory.getLogger(CasExceptionPageUtils.class);
	...
	public String doExcepiton(String errMessage,String appNo){
		...
		return "/casTask/apply/common/error/excepitonPageErr.ftl";
