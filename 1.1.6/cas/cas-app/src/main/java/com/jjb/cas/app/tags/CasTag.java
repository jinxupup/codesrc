...
@Component
public class CasTag extends UnicornFunctionRouterTag{
	@Autowired
...
//	private TmAppInstalProgramTermsDao appInstalProgramTermsDao;
	...
	public LinkedHashMap<Object,Object> tableMap(List arguments){
		...
		String arg4 = null;
		if(arguments.size()>3){
			arg4 =  arguments.get(3).toString();
		}
		if(StringUtils.isNotEmpty(method)){
			if(method.equals("productForStatus")){//获取卡产品下拉列表
				return cacheContext.getSimpleProductLinkedMap(filters,arg4);
...
//				}
			...
			}else if(method.equals("productForPointRule")){
				return cacheContext.getTmPointMainMap();	
