...
<@body>
    <@panelBody>
        <@form id="preToDoQueryForm" cols="4">
            <@row>
            ...
            <@row>
                ...
                <@toolbar align="right" style="margin-right:80px">
                    ...
                    <@buttonAuth code="CAS_TASK_ASSIGN_PRE">
                        <@button id="preassignTask" name="预审转分配" style="margin-right:16px"/>
                    </@buttonAuth>
                </@toolbar>
            </@row>
        </@form>
        <@table id="home" url="cas_tasklist/preTodoTaskList" form_id="preToDoQueryForm" button_id="todoQueryButton" page_size="25" load_auto="true">
            <@th checkbox="true"/>
...
<script type="text/javascript">
    ...
    function changeTitle(){
        var title = "";
        var that = top.$("[href='cas_tasklist/preToDoTaskListPage']");
        var lis = top.$("[href='cas_tasklist/preToDoTaskListPage']", top.$('#side-menu')).parents("ul");
