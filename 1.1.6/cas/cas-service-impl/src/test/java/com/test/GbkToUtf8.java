...
public class GbkToUtf8 {
	public static void main(String[] args) {
		String srcDir = "D:\\workspace_f\\gmp-1.0.0";   //工程源代码
		String destDir = "D:\\workspace_f\\gmp-1.0.0-utf8";   //转换编码格式后的存放目录，该目录可以不存在
	...
	private static String covert(File srcFile ,File destFile) {
		...
		try {
			InputStreamReader isr  = new InputStreamReader(new FileInputStream(srcFile), Charset.forName("GBK"));
