...
<@table id="dataTable" url="personalBlacklist/tmBlackUploadList" form_id="queryForm" button_id="queryButton">
    <@th checkbox="true"/>
    ...
    <@th title="操作" render="true">
        <@ajaxButton  confirm="确定删除此记录？" sense="danger"  name="删除" url="personalBlacklist/deleteTmBlackUpload?id={{row.id}}" success_url="personalBlacklist/fileUpload?isEdit=Y"/>
        <@href href="personalBlacklist/download?id={{row.id}}" name="下载"/>
    </@th>
</@table>