...
<@tab id="simpleRuleSetTab" >
    <@tabNav> 
        <@tabTitle pane_id="simpleRuleSetTab_pane1"  title="规则集信息">
        </@tabTitle>    
        <@tabTitle id="simpleRuleSetTab_title2" pane_id="simpleRuleSetTab_pane2" active="true"  title="<i class='fa fa-street-view'></i> 规则列表">
        </@tabTitle>
    </@tabNav>
    <@tabContent style="padding-left:0px;padding-right:0px;padding-top:5px;padding-bottom:0px;"> 
        <@tabPane id="simpleRuleSetTab_pane1" >
        ...
        <@tabPane id="simpleRuleSetTab_pane2" style="padding:5px;" active="true">
            <#include "simple/simple-rule-list.ftl" />
        </@tabPane>
    </@tabContent>
</@tab>
